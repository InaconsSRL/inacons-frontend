...
// import { getTitulosByPresupuesto, addTitulo, updateTitulo, deleteTitulo } from '../../../../slices/tituloSlice';
...
//     const [editingTitulo, setEditingTitulo] = useState<ITitulo | null>(null);
//     const [titulosEnEdicion, setTitulosEnEdicion] = useState<ITitulo[]>([]);
...
//     const handleEdit = (titulo: ITitulo) => {
...
//     const handleSubmit = async (tituloData: ITitulo) => {
//         if (editingTitulo) {
...
//     const calcularEstructuraInterna = async (titulos: ITitulo[]): Promise<ITitulo[]> => {
//         // Ordenar por orden
...
//     const calcularItem = (titulo: ITitulo, titulosAnteriores: ITitulo[]): string => {
//         if (titulo.nivel === 1) {
...
//     const encontrarPadreApropiado = (titulo: ITitulo, titulosAnteriores: ITitulo[]): ITitulo | null => {
...
//     const tieneHijos = (tituloId: string, titulos: ITitulo[]): boolean => {
//         return titulos.some(t => t.id_titulo_padre === tituloId);
//     };

//     const esHijoDeTituloColapsado = (titulo: ITitulo, titulos: ITitulo[]): boolean => {
...
//                         <h1 className="text-base font-bold  flex-grow break-words max-w-[800px] mb-2">
