...
const AprobarRequerimientoGerencia = ({ requerimiento }: AprobarRequerimientoProps) => {
  ...
  const aprobarRequerimiento = async () => {
    try {
      ...
      const data = {
        ...
        estadoAprobacion: "aprobado_gerencia",
...
export default AprobarRequerimientoGerencia;