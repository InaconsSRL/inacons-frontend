...
import { Detalle, Recurso } from './tipos'; // Asegúrate de que estos tipos estén definidos en un archivo de tipos



interface RecepcionOrdenProps {
    detalles: Detalle[]; // Cambiar a un tipo más específico según la estructura de los detalles
    recursos: Recurso[]; // Cambiar a un tipo más específico según la estructura de los recursos
    onClose: () => void;
}

const RecepcionOrden: React.FC<RecepcionOrdenProps> = ({ detalles, recursos, onClose }) => {
