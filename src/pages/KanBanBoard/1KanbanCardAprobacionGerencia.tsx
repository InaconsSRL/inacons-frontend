...
import AprobarRequerimientoGerencia from '../AprobacionRequerimientoPage/AprobarRequerimientoGerencia';

interface KanbanCardProps {
  task: Task;
}

const KanbanCardAprobacionGerencia: React.FC<KanbanCardProps> = ({ task }) => {
  ...
  const handleModalOpen = () => {
    ...
    return (
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-4 hover:shadow-md transition-shadow">
        ...
        >
          <AprobarRequerimientoGerencia requerimiento={task} />
        </Modal>
      </div>
    );
  };

export default KanbanCardAprobacionGerencia;