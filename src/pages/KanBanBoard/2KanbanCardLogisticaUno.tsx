...
const KanbanCardLogisticaUno: React.FC<KanbanCardProps> = ({ column }) => {
      ...
      <div className='grid grid-cols-3'>
        ...
        <div className='col-span-1 flex flex-col justify-around items-center'>
          <div className="flex -space-x-2">
            {requerimiento.aprobacion?.map((cargo, index) => (
              <div
                key={index}
                ...
                title={cargo.cargo || ''}
              >
                {cargo.cargo ? cargo.cargo.charAt(0) : ''}
              </div>
            )) || []}
          </div>
          <button
...
export default KanbanCardLogisticaUno;