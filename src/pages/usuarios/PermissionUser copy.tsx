...
const PermissionUser: React.FC<PermissionUserProps> = ({ title, initialPermissions, initialName, initialDescription }) => {
  ...
  const handleSubmit = async () => {
    {/* Aquí podrías hacer la lógica para enviar los datos a la base de datos */}
  };
